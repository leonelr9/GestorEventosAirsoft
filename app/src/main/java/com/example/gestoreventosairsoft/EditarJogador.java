...
public class EditarJogador extends AppCompatActivity {
    ...
    public void Guardar(View view) {
        ...
        EditText editTextGrupoSanguineo = (EditText) findViewById(R.id.editTextGrupoSanguineo);
        String gruposanguineo = editTextGrupoSanguineo.getText().toString();

        EditText editTextNumSocio = (EditText) findViewById(R.id.editTextNumSocio);
